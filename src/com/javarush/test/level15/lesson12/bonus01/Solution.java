...
public class Solution {
    ...
    public static void reset() throws IOException {
        BufferedReader typeFly = new BufferedReader(new InputStreamReader(System.in));
        String typeFlyable = typeFly.readLine();
        if(typeFlyable.equals("plane")){
            int countPassengers = Integer.parseInt(typeFly.readLine());
            result = new Plane(countPassengers);
            //add your code here - добавьте код тут
        }if(typeFlyable.equals("helicopter")){
