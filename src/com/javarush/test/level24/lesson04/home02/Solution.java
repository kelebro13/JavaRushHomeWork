        ...
        public void someAction() {
            ...
            if(param > 0){
                while(param != 0){
                    ...
                    if(param == 1){
                        class LocalFirstClass extends FirstClass{
                            @Override
                        ...
                        LocalFirstClass localFirstClass = new LocalFirstClass();
                        localFirstClass.someAction();
                    }
                    param--;
                ...
                String s = SecondClass.SPECIFIC_ACTION_FOR_ANONYMOUS_SECOND_CLASS_PARAM.substring(1, SecondClass.SPECIFIC_ACTION_FOR_ANONYMOUS_SECOND_CLASS_PARAM.length()-1) + " " + param;
